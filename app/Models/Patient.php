...
class Patient extends Model
{
    ...
    protected $fillable = [
        ...
        'hospital_reg_no', 'diagnosis', 'unit', 'ward_no', 'bed_no', 'admission_date','discharge_date','created_by','created_ip',
       'chief_complaints','present_illness', 'past_illness', 'comorbidities', 'family_history',
        'drug_history', 'previous_drug_history', 'previous_treatment_history', 'clinical_findings',
// 'cbc_result',
